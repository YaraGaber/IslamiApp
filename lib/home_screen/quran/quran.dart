...
class Quran extends StatelessWidget {
  late var provider ;
  List<String> suraName = contant.suraNames; // Assuming contant is correctly defined in contant_quran.dart
  List<int> verses = contant.versesNumber; // Assuming contant is correctly defined in contant_quran.dart
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Expanded(flex:3,child: Center(child: Image.asset('assets/images/Screenshot (1).png'))),
        SizedBox(height: 15),
        Expanded(
          flex: 7,
          child: Stack(
            ...
            itemBuilder: (BuildContext context, int index) {
              return Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: SuraItem(name: suraName[index],
                      index: index,
