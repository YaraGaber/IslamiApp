...
class _SbhaState extends State<Sbha> {
  ...
  List<String> texts = ['سبحان الله', 'الحمد لله', 'الله أكبر']; // Add more texts as needed
  ...
  Widget build(BuildContext context) {
    ...
    return  Column(
      children: [
        ...
        SizedBox(height: 10),
        Center(child: Text('عدد التسبيحات', style: Theme.of(context).textTheme.titleLarge)),
        Container(
