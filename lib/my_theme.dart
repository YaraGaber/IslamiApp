...
class MyTheme {
  ...
  static TextStyle regularTitle = TextStyle(
      fontSize: 25, fontWeight: FontWeight.w400, color: MyTheme.black);
  static TextStyle darkbold = TextStyle(
    fontWeight: FontWeight.w600,
    fontSize: 25,
    color: white,
  );
  static TextStyle darksemibold =
      TextStyle(fontSize: 25, fontWeight: FontWeight.w400, color: white);
  static TextStyle darksemiboldYallow =
      TextStyle(fontSize: 25, fontWeight: FontWeight.w400, color: yallow);
  ...
  static ThemeData darkmood = ThemeData(
    ...
    textTheme: TextTheme(
        ...
        titleSmall: TextStyle(
            fontSize: 25, fontWeight: FontWeight.w400, color: yallow)),
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
